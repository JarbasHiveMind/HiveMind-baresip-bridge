...
def test_the_bridge_asks_for_its_own_identity_and_hands_it_to_the_client():
    from hivemind_baresip_bridge import __main__ as entry
    identity = _identity()
    with patch.object(entry, "NodeIdentity", return_value=identity) as ctor, \
         patch.object(entry, "init_service_logger"), \
